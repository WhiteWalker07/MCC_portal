 ...
 *
 * Ported verbatim from functions/src/engine/points.ts (pure — no Firestore).
 *
 * Base:
 ...
 *   >  lateThresholdHours  -> -(latePenaltyPct + subsequentPenaltyPct per extra
 *                              block of subsequentDelayHours)%
...
export function finalPoints(base: number, turnaroundHours: number, cfg: PointsConfig): number {
